...
public class ChatBot {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("CHATBOT: I am ChatBot! I am here to make your day better. I have some jokes in my pocket and I am ready to use them!");
		Thread.sleep(3000);
		System.out.println("CHATBOT: Tell me how is your day? (Enter: Great/ Fine/ Sad)");
		...
		while (true) {
			if (mood.equalsIgnoreCase("Fine")) {
				...
				System.out.println("CHATBOT: Heeeeeey! I didn't understand you! Tell me how is your day? (Enter: Great/ Fine/ Sad)");
				mood = sc.nextLine();
				continue;
			}
